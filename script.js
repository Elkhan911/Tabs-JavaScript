...
link1.addEventListener("click", function () {
  tabText1.classList.add("content__text_active");
  link1.classList.add("tabs__link_active");

  tabText2.classList.remove("content__text_active");
  tabText3.classList.remove("content__text_active");
...
link2.addEventListener("click", function () {
  tabText2.classList.add("content__text_active");
  link2.classList.add("tabs__link_active");

  tabText1.classList.remove("content__text_active");
  tabText3.classList.remove("content__text_active");
...
link3.addEventListener("click", function () {
  tabText3.classList.add("content__text_active");
